...
export default function ReportGenerator() {
      ...
      const [reportResult, setSummaryResult] = useState<QueryResult | null>(
            null
      );
      ...
      const generateReport = useCallback(async () => {
            ...
            try {
                  const [s, d, c, p, pr, t, cu, da, co] = await Promise.all([
                        supabase.rpc('fn_period_executive_summary', {
                              from_date: fromDate,
                              to_date: toDate,
                        }),
                        ...
                        supabase.rpc('fn_period_revenue_by_category', {
                              from_date: fromDate,
                              to_date: toDate,
                        }),
                        ...
                        supabase.rpc('fn_period_price_sensitivity', {
                              from_date: fromDate,
                              to_date: toDate,
                        }),
                        supabase.rpc('fn_period_time_intelligence', {
                              from_date: fromDate,
                              to_date: toDate,
                        }),
      ...
      const generateDReport = useCallback(
            async (type: 'summary' | 'sales') => {
                  setLoading2(true);
                              ...
                              <div className="flex flex-col items-center justify-center py-24 gap-4">
                                    ...
                                    <div className="text-center">
                                          ...
                                          <p className="text-ink-muted text-sm font-body mt-1">
                                                Choose a period and click
                                                Generate Report to see full
                                                analytics
                                          </p>
                                    </div>
                              </div>
