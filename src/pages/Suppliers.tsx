...
export default function SuppliersPage() {
      ...
      const totalCostValue = all.reduce(
            (s, r) => s + Number(r.stock_cost_value ?? 0),
            0
      );
      const totalRetailValue = all.reduce(
            (s, r) => s + Number(r.stock_retail_value ?? 0),
            0
      );
      ...
      const totalProducts = all.reduce(
            (s, r) => s + Number(r.num_products ?? 0),
            0
      );

      const maxCostValue = Math.max(
            ...all.map((r) => Number(r.stock_cost_value ?? 0)),
            1
      );
      ...
      return (
            <div className="flex-1 flex flex-col min-h-screen">
                  <TopBar
                        title="Suppliers"
                        subtitle="Stock value and outstanding balances"
                  />
                  ...
                  <main className="flex-1 p-6 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                              <StatCard
                                    ...
                                    value={fmtCurrency(totalCostValue)}
                              ...
                              <StatCard
                                    ...
                                    value={fmtCurrency(totalRetailValue)}
                        ...
                        <Card glow>
                              <CardHeader>
                                    <CardTitle>
                                          Retail Stock Value by Supplier
                                    </CardTitle>
                              </CardHeader>
                              {suppliers.loading ? (
                        ...
                        <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
                              {suppliers.loading
                                    ? Array.from({ length: 4 }).map((_, i) => (
                                            <Card key={i}>
                                                  <div className="h-24 bg-bg-hover animate-pulse rounded-lg" />
                                            </Card>
                                      ))
                                    : all.map((s) => {
                                            const cost = Number(
                                                  s.stock_cost_value ?? 0
                                            );
                                            const retail = Number(
                                                  s.stock_retail_value ?? 0
                                            );
                                            ...
                                            return (
                                                  ...
                                                  >
                                                        ...
                                                        <div className="grid grid-cols-3 gap-3 mb-4">
                                                              <div>
                                                                    <p className="text-[10px] text-ink-muted font-body uppercase tracking-wider mb-1">
                                                                          Cost
                                                                    </p>
                                          ...
                                          <tbody>
                                                {all.map((s) => {
                                                      ...
                                                      return (
                                                            ...
                                                            >
                                                                  <td className="py-3 pr-4 text-xs font-body text-ink-primary">
                                                                        {
                                                                              s.supplier_name
                                                                        }
                                                                  </td>
                                                                  ...
                                                                  <td className="py-3 pr-4 text-xs font-mono text-accent-gold">
                                                                        {fmtCurrency(
                                                                              retail
                                                                        )}
                                                                  </td>
