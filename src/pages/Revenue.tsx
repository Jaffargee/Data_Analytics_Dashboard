...
export default function RevenuePage() {
      ...
      const momChange =
            latestMonth && prevMonth
                  ? ((latestMonth.revenue - prevMonth.revenue) /
                          prevMonth.revenue) *
                    100
                  : null;
      ...
      return (
            <div className="flex-1 flex flex-col min-h-screen">
                  <TopBar
                        title="Revenue"
                        subtitle="Detailed revenue analysis"
                  />
                  ...
                  <main className="flex-1 p-6 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                              <StatCard
                                    ...
                                    value={fmtCurrency(totalAllTime)}
                                    accent="gold"
                                    delay={0}
                              />
                              <StatCard
                        ...
                        <Tabs.Root defaultValue="monthly">
                              <div className="flex items-center justify-between mb-4">
                                    <Tabs.List className="flex gap-1 bg-bg-panel border border-bg-border rounded-lg p-1">
                                          {['monthly', 'daily', 'custom'].map(
                                                (v) => (
                                                      <Tabs.Trigger
                                                            key={v}
                                                            value={v}
                                                            className="px-4 py-1.5 text-xs font-body rounded-md text-ink-secondary data-[state=active]:bg-accent-gold/15 data-[state=active]:text-accent-gold data-[state=active]:border data-[state=active]:border-accent-gold/30 hover:text-ink-primary transition-all capitalize"
                                                      >
                                                            {v}
                                                      </Tabs.Trigger>
                                                )
                                                            ...
                                                            <tr className="border-b border-bg-border">
                                                                  {[
                                                                        ...
                                                                        <th
                                                                              ...
                                                                              className="text-left pb-3 text-xs font-body uppercase tracking-wider text-ink-muted pr-4"
                                                                        >
                                                                              {
                                                                                    h
                                                                              }
                                                            ...
                                                            {[
                                                                  ...
                                                                  .map(
                                                                        (
                                                                              ...
                                                                              >
                                                                                    <td className="py-3 pr-4 font-mono text-ink-primary text-xs">
                                                                                          {
                                                                                                r.month
                                                                                          }
                                                                                    </td>
                                                                                    ...
                                                                                    <td className="py-3 pr-4 text-accent-gold font-mono text-xs font-medium">
                                                                                          {fmtCurrency(
                                                                                                r.revenue
                                                                                          )}
                                                                                    </td>
                                                                                    <td className="py-3 pr-4 text-ink-secondary text-xs font-mono">
                                                                                          {fmtCurrency(
                                                                                                r.avg_sale
                                                                                          )}
                                                                                    </td>
                                                                                    <td className="py-3 text-ink-secondary text-xs">
                                                                                          {fmt(
                                                                                                r.items_sold
                                                                                          )}
                                                                                    </td>
                                                      ...
                                                      <tbody>
                                                            {(
                                                                  ...
                                                                  <tr
                                                                        ...
                                                                        className="border-b border-bg-border/50 hover:bg-bg-hover transition-colors"
                                                                  >
                                                                        <td className="py-2.5 pr-4 font-mono text-ink-primary text-xs">
                                                                              {fmtDate(
                                                                                    r.sale_date
                                                                              )}
                                                                        </td>
                                                                        <td className="py-2.5 pr-4 text-ink-secondary text-xs">
                                                                              {fmt(
                                                                                    r.num_sales
                                                                              )}
                                                                        </td>
                                                                        <td className="py-2.5 pr-4 text-accent-teal font-mono text-xs font-medium">
                                                                              {fmtCurrency(
                                                                                    r.revenue
                                                                              )}
                                                                        </td>
                                                                        <td className="py-2.5 text-ink-secondary text-xs">
                                                                              {fmt(
                                                                                    r.items_sold
                                                                              )}
                                                                        </td>
