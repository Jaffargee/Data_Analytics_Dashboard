...
const SIZE_CLASSES: Record<ButtonSize, string> = {
      xm: "h-[28px] px-[10px] text-[10px] gap-[2px]",
...
const VARIANT_CLASSES: Record<ButtonVariant, string> = {
      ...
      primary: "bg-accent-gold text-black hover:bg-accent-gold/90 active:bg-accent-gold/80 border border-transparent",

      // Outlined — secondary action
      secondary: "bg-transparent border border-[#f0f0fa59] text-ink-primary hover:bg-white/[0.04] hover:border-ink-faint active:bg-white/[0.08]",

      // Dashed — additive action ("+ Add item")
      dashed: "bg-transparent border border-dashed border-[#f0f0fa40] text-ink-muted hover:bg-white/[0.02] hover:border-[#f0f0fa80] hover:text-ink-primary active:bg-white/[0.05]",

      // Gold tinted outline — contextual accent
      accent: "bg-accent-gold/[0.12] border border-accent-gold/30 text-accent-gold hover:bg-accent-gold/[0.20] active:bg-accent-gold/[0.08]",

      // No background — subtle/icon-adjacent
      ghost: "bg-transparent border border-transparent text-ink-muted hover:bg-white/[0.04] hover:text-ink-primary active:bg-white/[0.08]",
