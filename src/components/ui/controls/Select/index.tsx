      ...
      return (
            <div className={cn("w-full font-body relative", className)} ref={containerRef}>
                  ...
                  <div
                        ...
                        className={cn(
                              "relative flex items-center bg-transparent border transition-all duration-200 box-border cursor-pointer select-none overflow-visible",
                              FIELD_HEIGHT,
                              // Radius
                              `rounded-${radius}`,
                  ...
                  >
                        ...
                        <div className="relative flex-1 h-full flex items-center overflow-visible min-w-0">
                              ...
                              <label
                                    className={cn(
                                          "z-10 absolute pointer-events-none transition-all duration-200 origin-top-left text-ink-subtle leading-none select-none",
                                          "text-[14px]",
