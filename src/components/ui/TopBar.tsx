      ...
      return (
            <header className="h-14 border-b border-bg-border bg-bg-panel/80 backdrop-blur-md px-6 flex items-center justify-between sticky top-0 z-10">
                  ...
                  <div className="flex flex-row gap-2">
                        <button onClick={() => navigate(-1) } className="w-8 h-8 rounded-lg border border-bg-border text-ink-muted hover:text-ink-primary hover:bg-bg-hover flex items-center justify-center transition-all">
                              <ArrowLeft size={18} />
                        </button>
                  ...
                  <div className="flex items-center gap-2">
                        ...
                        {onRefresh && (
                              <button onClick={onRefresh} className="w-8 h-8 rounded-lg border border-bg-border text-ink-muted hover:text-ink-primary hover:bg-bg-hover flex items-center justify-center transition-all">
                                    <RefreshCw size={13} />
                              </button>
                        )}
