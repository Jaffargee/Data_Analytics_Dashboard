      ...
      return (
            <div className={cn("w-full font-body", className)}>
                  ...
                  >
                        ...
                        <div className={cn(
                              "relative flex-1 h-full flex items-center overflow-visible",
                              prefix ? "pl-[42px]" : ""
                        )}>
                              <input
                                    ref={inputRef}
                              ...
                              <label
                                    htmlFor={inputId}
                                    className={cn(
                                          "z-[2000] absolute pointer-events-none transition-all duration-200 origin-top-left text-ink-subtle leading-none select-none",
                                          ...
                                          "peer-focus:top-[0px] peer-focus:-translate-y-1/2 peer-focus:text-[14px] peer-focus:bg-black peer-focus:px-[4px]",
