                        ...
                        <Card>
                              ...
                              <div className="space-y-4">
                                    {all.map((r, i) => (
                                          <div
                                                key={i}
                                                className="flex items-center gap-4 p-3 rounded-lg bg-bg-hover/40 hover:bg-bg-hover transition-colors"
                                          >
                                                ...
                                                <div className="flex-1 min-w-0">
                                                      <div className="flex items-center justify-between mb-1">
                                                            ...
                                                            <span className="text-xs font-mono text-accent-purple ml-2 shrink-0">
                                                                  {fmtCurrency(
                                                                        r.total_revenue
                                                                  )}
                                                            </span>
